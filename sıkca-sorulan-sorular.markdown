...
[Android uygulaması](https://play.google.com/store/apps/details?id=com.bildik.linuxdersleri){:target="_blank"} çevrimdışı çalışma için gerekli olabilecek minimum içeriğe sahip şekilde webview üzerinde statik olarak sunuluyor. Ancak maalesef ki iOS market kuralları, yanlızca webview formatındaki uygulamaları kabul etmiyor. Ben iOS geliştiricisi olmadığım için, işlevsel bir platform uygulaması da henüz sunmam mümkün değil. Ayrıca çevrimdışı uygulamaya ihtiyaç duyan kitlenin azlığı dolayısıyla pek mantıklı ve sürdürülebilir değil. Zaten Android uygulaması içerisinde, web platforumdan çok daha az içerik sunuyorum. Daha kapsamlı deneyim için Android cihazınız üzerinden de web tarayıcınızı kullanarak [linuxdersleri.net](https://linuxdersleri.net){:target="_blank"} adresini ziyaret etmeniz gerekiyor. Yani aslında istediğiniz mobil cihaz üzerinden web tarayıcısı sayesinde tüm içeriğe sorunsuzca erişebilirsiniz. iOS için yalnızca, mevcut platformdaki bilgiler kaynak alınarak hazırlanmış olan basit bir [test uygulaması](https://apps.apple.com/us/app/linux-testi/id6474895980) bulunuyor. Şimdilik harici bir uygulama çıkarma gibi bir planım yok.
